...
impl AndroidSafReader {
    pub fn new(core: Arc<AndroidSafCore>, file: tokio::fs::File, size: usize) -> Self {
        Self {
            core,
            file,
            read: 0,
...
impl oio::Read for AndroidSafReader {
