...
- Thumbnail generation, cache policy and hidden-path governance now live in VFS business services; upper layers should only call the shared VFS thumbnail service instead of reimplementing generators.
